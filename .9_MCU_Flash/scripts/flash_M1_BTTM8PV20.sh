...
# ===============================
# Flash Mainboard (BTT Manta M8P V2.0)
# ===============================
...
CONFIG_FILE="/home/gueee/printer_data/config/0_Xplorer/.9_MCU_Flash/MCU_config/BTT_Manta_M8P_V2.0/.config"
KLIPPER_DIR="/home/gueee/klipper"

echo "=== MCU Flash Script (Mainboard / BTT Manta M8P V2.0) ==="
